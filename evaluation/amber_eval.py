...
def get_args():
    ...
    parser.add_argument("--word_association", type=str, default='data/amber/relation.json')
    parser.add_argument("--safe_words", type=str, default='data/amber/safe_words.txt')
    parser.add_argument("--inference_data", type=str)
    parser.add_argument("--annotation", type=str, default='data/amber/annotations.json')
    parser.add_argument("--metrics", type=str, default='data/amber/metrics.txt')
